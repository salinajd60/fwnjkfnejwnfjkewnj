...
import {
  constructSig,
  constructSigForBridgeAssetTargetChainSol,
  getMessageHash,
...
const SOL_MINT_PUBKEY = new PublicKey("So11111111111111111111111111111111111111111");
...
async function constructInputSigs(): Promise<Ed25519Signature[]> {
  const ed25519sig1 = await constructSigForBridgeAssetTargetChainSol(
    GUARDIAN1_KEYPAIR,
    SENDER.publicKey,
    RECIPIENT.publicKey,
    SOL_MINT_PUBKEY,
